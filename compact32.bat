...
if not exist "C:\Windows\Temp\ultradefrag.zip" (
    powershell -Command "(New-Object System.Net.WebClient).DownloadFile('http://downloads.sourceforge.net/ultradefrag/ultradefrag-portable-6.0.2.bin.i386.zip', 'C:\Windows\Temp\ultradefrag.zip')" <NUL
)

if not exist "C:\Windows\Temp\ultradefrag-portable-6.0.2.i386\udefrag.exe" (
...
cmd /c C:\Windows\Temp\ultradefrag-portable-6.0.2.i386\udefrag.exe --optimize --repeat C:
